...
import { AddressItem, ProductPublicInfo } from '~/types'
    ...
    submit(
      {
        ...
        currency: storeSettings!.currency.code.toLowerCase(),
      },
      { method: 'POST' },
    )
  }
      ...
      <div className="max-w-screen-xl mx-auto h-auto pt-24">
        {submitted ? (
          ...
          <>
                        ...
                        <>
                          ...
                          <div className="mb-4">
                            ...
                            <div className="flex items-center mb-4">
                              ...
                              >
                                {t(
                                  'system.billing_address_same_shipping_address',
                                )}
                              </label>
                            </div>
                          </div>
            ...
            {storeSettings && suggestedProducts && (
              <>
